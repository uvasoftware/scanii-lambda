...
- Moved the AWS deployment link into a prominent `Deploy on AWS` section and
  moved brittle endpoint enumeration out of the README in favor of the
  maintained endpoint documentation.
